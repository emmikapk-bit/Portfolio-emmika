...
export const heroFlowers = [
  { size: 'lg', top: '4%', left: '3%', duration: '16s', delay: '-1s', direction: 'normal' },
  { size: 'sm', top: '6%', left: '22%', duration: '11s', delay: '-5s', direction: 'reverse' },
  { size: 'sm', top: '7%', right: '18%', duration: '13s', delay: '-2s', direction: 'normal' },
  { size: 'md', top: '10%', right: '4%', duration: '15s', delay: '-7s', direction: 'reverse' },
  { size: 'sm', top: '31%', left: '11%', duration: '12s', delay: '-3s', direction: 'normal' },
  { size: 'md', top: '39%', right: '11%', duration: '17s', delay: '-6s', direction: 'reverse' },
  { size: 'sm', top: '32%', right: '1%', duration: '10s', delay: '-4s', direction: 'normal' },
  { size: 'sm', bottom: '28%', left: '1%', duration: '14s', delay: '-9s', direction: 'reverse' },
  { size: 'md', bottom: '20%', left: '16%', duration: '18s', delay: '-8s', direction: 'normal' },
  { size: 'lg', bottom: '15%', right: '3%', duration: '20s', delay: '-10s', direction: 'reverse' },
]
...
export const infoCards = [
  { title: 'Background', value: '2+ Years in Operations', motion: ['12s', '-1s', 'normal'] },
  { title: 'Program', value: 'JSD-12 Generation Thailand', motion: ['15s', '-4s', 'reverse'] },
  { title: 'Degree', value: 'Home economics fashion merchandise', motion: ['13s', '-2s', 'normal'] },
